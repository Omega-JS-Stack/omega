...
* [ ] Phase 1: Foundation packages
  ...
  * [ ] Task 1.1d-part2: desktop adopts runner core (its runner.js + electron/boot glue); framework-specific runners (chromium/electron/boot harnesses) stay framework-side for now — revisit sharing UJM↔BXM chromium plumbing when @omegajs/web is built
