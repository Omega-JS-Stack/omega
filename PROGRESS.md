...
## 🎯 Now
- **SECTIONS SPEC RATIFIED (cp202/203, Ian 2026-07-18) — extraction IN FLIGHT, cp204–206 LANDED**: [plans/omega-sections-spec.md](plans/omega-sections-spec.md) is binding; cp204 = machinery + hero; cp205 = whole classy index is composition (testimonials shared ×4, include deleted, shared-band ruling → spec §6); cp206 = CTA-family CONVERGENCE (marketing/cta union args serves 8 pages — about/pricing/download/extension/team/alternatives×2 + index; ~170 lines of band copies die; keys harmonized subheadline/primary_button) — goldens: cp205 97/97 byte-identical, cp206 zero content diffs (12 converged pages ws-only, h2-boundary neutral); web 200/0, corpus 7/7; next: newsletter pair → remaining classy pages → newsflash
