...
- [docs/paypal-sandbox-qa.md](../../packages/backend/docs/paypal-sandbox-qa.md) — the live PayPal sandbox QA drive: standing fixtures (creds, webhook, the trial-free `proof-press` product, the sandbox buyer), the subscription sale → refund sequence, and the gotchas
