...
- **`omega:em`** — router skill. Auto-loads on desktop-specific keywords (`manager.windows`, `manager.tray`, `electron-builder`, `npx omega setup`, etc.) and points back to this guide + `docs/` (the SSOT), carrying only Claude-workflow hard rules and process checklists.
...
- [docs/runner.md](../../packages/desktop/docs/runner.md) — Windows EV-token signing runner
...
- [docs/build-system.md](../../packages/desktop/docs/build-system.md) — gulp, webpack, electron-builder pipeline
