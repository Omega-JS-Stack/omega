...
> - **#1 enum enforcement — OPEN, awaiting Ian** (asked "what do you mean"; explained in the cp79 report). Today `enum:` on `user/oauth2` action fields is decorative; enforcing would 400 out-of-enum values.
