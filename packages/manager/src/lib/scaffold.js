...
const ENV_GROUPS = [
  ...
  { comment: 'Pixel access tokens (analytics service; the names backend-manager reads)', keys: ['META_ACCESS_TOKEN', 'TIKTOK_ACCESS_TOKEN'] },
  { comment: 'Email marketing (sendgrid + beehiiv services) + the parent BEM webhook key', keys: ['SENDGRID_API_KEY', 'BEEHIIV_API_KEY', 'BACKEND_MANAGER_WEBHOOK_KEY'] },
