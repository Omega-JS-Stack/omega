/**
 * backend-manager's marketing SSOT — the FIELDS + SEGMENTS dictionaries that
 * define every custom field and segment BEM expects in the marketing
 * providers (SendGrid, Beehiiv). Required straight from the backend-manager
 ...
 */
const { FIELDS, SEGMENTS } = require('backend-manager/src/manager/libraries/email/constants.js');
...
module.exports = { BEM_FIELDS_MAP: FIELDS, BEM_FIELDS, BEM_SEGMENTS, fieldsFor, segmentsFor };
