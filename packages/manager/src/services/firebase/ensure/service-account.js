/**
 * Ensure the Firebase Admin SDK service account exists with the roles BEM
 ...
 * functions/ dir (where BEM expects it) whenever missing there.
 *
...
module.exports = async function ensureServiceAccount(context) {
  ...
  // Source of truth + the backend copy BEM reads
