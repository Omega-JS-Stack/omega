/**
 * languages.js — ISO 639-1 code => [English name, Native name].
 *
 * Machine-extracted verbatim from jekyll-uj-powertools lib/tags/language.rb
 * (LANGUAGE_MAPPINGS) — do not hand-edit; regenerate from the Ruby source.
 */
