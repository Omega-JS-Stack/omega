// Framework-provided dependencies (#87), extension half: a CONSUMER module requires any
...
// wrapper composes from the framework's declared dependency set
// ([#738](https://github.com/Omega-JS-Stack/omega/issues/738), replacing the ordered
// `resolve.modules` webpack used), so these tests build a real consumer entry through
// the wrapper and read the resolved paths back out of the metafile.
//
...
// Build `src/entry.js` the way the extension lane builds a component bundle, and
// return every input path the bundle pulled in (absolute, real).
