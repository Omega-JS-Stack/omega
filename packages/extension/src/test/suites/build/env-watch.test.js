...
// re-stages and the running emulator sees it — while the extension's gulp read
// the cascade once at boot and never noticed an edit. This pins the PATH
...
module.exports = defineCases({
  ...
  tests: [
    ...
    },
    {
      ...
      run: (ctx) => {
        const root = fs.realpathSync(fs.mkdtempSync(path.join(os.tmpdir(), 'extension-env-watch-solo-')));
