...
| U-05 | HIGH | C | No @omega.js/extension transitive deps installed in the consumer `package.json` (`firebase`, `@omega.js/client`, `json5`, …) — the bundler's framework-deps hook / `Manager.require()` resolve them ([common-mistakes.md](common-mistakes.md), [the framework guide](../../../docs/extension/index.md) §Dependency Resolution) |
