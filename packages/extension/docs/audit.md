...
| U-05 | HIGH | C | No @omegajs/extension transitive deps installed in the consumer `package.json` (`firebase`, `web-manager`, `json5`, …) — webpack `resolve.modules` / `Manager.require()` resolve them ([common-mistakes.md](common-mistakes.md), [CLAUDE.md](../CLAUDE.md) §Dependency Resolution) |
