...
1. **Read configuration**: from `window.OMEGA_BUILD_JSON?.config` (assigned by the one `/build.js` the page template loads first, [#743](https://github.com/Omega-JS-Stack/omega/issues/743))
