/**
 * Ad unit behavior — hands the inner host to the shared client ads module,
 ...
 * across web/desktop/extension (the data-omega-ad vocabulary). Paying users
...
export default (el) => {
  const $host = el.querySelector('.omega-ad-unit');
  if (!$host) {
    return;
  }
