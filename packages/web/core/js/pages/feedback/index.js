...
export default () => {
  return new Promise(async function (resolve) {
    // Warm the backend the moment the page loads: the only thing this page
    // does is POST `/omega/user/feedback`, so the visitor's first click is the
    // one that would pay for a cold function. Fire-and-forget and
