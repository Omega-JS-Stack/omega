/**
 * The OMEGA service worker: the master-service-worker successor.
...
/**
 * The service worker runtime: one instance per worker, the module's default
 * export. The class is exported by name for tests.
 */
class Omega {
  constructor() {
    // Properties
  ...
  initializeFirebase() {
    ...
    // Attach firebase to the instance
