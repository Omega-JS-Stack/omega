 ...
 *
 * The generated pages ride the shared redirect-page shape (redirect-page.js):
 * source strings registered as virtual templates on the same lane as the
 * framework's default pages.
 */
...
function socialPages(entries) {
  return entries.map((entry) => redirectPage({
    ...
    note: `Social shortlink generated by @omega.js/web from socials.${entry.key} (#429).`,
  }));
}
