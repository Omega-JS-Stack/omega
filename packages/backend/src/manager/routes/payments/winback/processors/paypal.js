/**
 * PayPal winback processor — DELIBERATELY EMPTY.
 *
 ...
 * `typeof processorModule.applyOffer === 'function'`, so the absent export IS the
 * declaration, and the caller gets a `not-supported-by-processor` 400 that the
