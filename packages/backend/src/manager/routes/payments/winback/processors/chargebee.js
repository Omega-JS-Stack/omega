/**
 * Chargebee winback processor — DELIBERATELY EMPTY, for now.
 *
 * Chargebee DOES have coupons, and the checkout already creates them
 * (resolveChargebeeCoupon in routes/payments/intent/processors/chargebee.js).
 ...
 * with whatever is sent (see the plan-switch processor). Carrying a coupon
 ...
 * `typeof processorModule.applyOffer === 'function'`, the caller gets a
 * `not-supported-by-processor` 400, and the billing card retires the offer and
 ...
 * processor", which is a different (and wrong) statement about Chargebee.
 */
module.exports = {};
