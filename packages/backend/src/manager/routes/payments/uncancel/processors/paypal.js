/**
 * PayPal uncancel processor — DELIBERATELY EMPTY.
 *
 ...
 * libraries/payment/processors/paypal.js). So a PayPal subscriber whose state
 ...
 * `typeof processorModule.uncancel === 'function'`, so the absent export IS the
 * declaration, and the caller gets a `not-supported-by-processor` 400 pointing at
 ...
 * processor", which is a different (and wrong) statement about PayPal.
 */
module.exports = {};
