/**
 * Chargeblast dispute alert provider
...
module.exports = {
  ...
  normalize(body) {
    ...
    return {
      ...
      // `processor` and `subprovider` are CHARGEBLAST's own payload field names —
      // read verbatim, normalized onto our `provider` word on the way out (#428)
      provider: body.processor ? String(body.processor).toLowerCase() : 'stripe',
