 ...
 * (libraries/payment/providers/paypal.js), so the cancellation webhook resolves
 ...
 * cancel this was, exactly as the Stripe and Chargebee providers do.
 */
module.exports = {
  /**
