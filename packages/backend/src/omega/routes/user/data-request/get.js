...
module.exports = async ({ ctx, omega, user, data }) => {
  ...
  const customQueries = omega.config.dataRequest?.queries || [];
  ...
  if (authRecordResult) {
    ...
    exported.authRecord = { error: 'Unable to retrieve auth record' };
  }
