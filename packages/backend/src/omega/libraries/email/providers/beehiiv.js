 ...
 *
 * Reads `omega.config.marketing.newsletter.providers.beehiiv.publicationId`
...
function getPublicationId() {
  const publicationId = instance().config?.marketing?.newsletter?.providers?.beehiiv?.publicationId;
