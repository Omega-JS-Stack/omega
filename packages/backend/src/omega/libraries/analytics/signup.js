 ...
 * @returns {object} The `deliverConversion` payload, minus its ctx + omega.
 */
 ...
 *
 * @param {object} options - `buildSignupFire`'s, plus the Omega instance and the ctx.
 * @returns {void}
 */
function trackSignup({ omega, ctx, authUser, userRecord, request }) {
  try {
    deliverConversion({
