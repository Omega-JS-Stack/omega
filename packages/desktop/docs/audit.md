...
| U-05 | HIGH | C | No @omegajs/desktop transitive deps installed in the consumer `package.json` (`firebase`, `web-manager`, `fs-jetpack`, …) — webpack `resolve.modules` resolves them ([common-mistakes.md](common-mistakes.md)) |
