// Minimal main entry for @omegajs/desktop's boot-layer self-test fixture. Mirrors a real consumer:
...
manager.initialize()
  .then(() => {
    ...
    logger.log('@omegajs/desktop fixture consumer main initialized!');
  });
