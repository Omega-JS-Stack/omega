...
// the shared devkit defaults engine; these tests run the REAL copyDefaults (EM's
  ...
  tests: [
    {
      ...
      run: async (ctx) => {
        ...
        // Workflow rendered with EM's engines.node; GitHub's `${{ }}` tokens survive.
    ...
    },
    {
      ...
      run: async (ctx) => {
        ...
        // Not in EM's defaults → migrated below the Custom marker.
