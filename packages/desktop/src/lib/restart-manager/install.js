...
// silent per-platform install. Install ONLY — RM updates ITSELF via EM's
...
//
// The RM app publishes releases through EM's standard pipeline: versioned
...
// install is never observable. The advisory install.lock keeps two EM apps on
...
// electron-updater feed file per platform (produced by EM's release pipeline).
 ...
 * belt-and-suspenders on top of EM's already-sanitized artifact names.
 *
 * @param {{ owner?: string, repo?: string, url?: string }} feedCfg
