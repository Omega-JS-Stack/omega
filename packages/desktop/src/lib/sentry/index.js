...
//                but in practice @omega.js/desktop's preload entry calls a different file. The preload module here is exposed
//                via `require('@omega.js/desktop/lib/sentry/preload')` directly when needed.
