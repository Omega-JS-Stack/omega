...
const appState = {
  ...
  launchedAtLogin() {
    // `getLoginItemSettings` exists on macOS + Windows; on Linux it just returns
    // a stub object with openAtLogin=false. So the field check below is safe
    // everywhere — no platform branch needed.
