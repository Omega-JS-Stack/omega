...
module.exports = [
  ...
  // ── restartManager ───────────────────────────────────────────────────────
  {
    ...
    type:        'boolean',
    required:    false,
    description: 'External guardian app that relaunches this app on crash (localhost HTTP protocol v1). Default true; false disables entirely.',
  },
  {
    ...
    required:    false,
    match:       /^[A-Za-z0-9-]+$/,
    description: 'GitHub owner of the RM release feed. Default restart-manager. Override for forks/mirrors.',
  },
  {
    ...
    required:    false,
    match:       /^[\w.-]+$/,
    description: 'GitHub repo of the RM release feed. Default update-server (the RM app publishes via the standard EM release pipeline).',
  },
  {
    ...
    required:    false,
    match:       /^https?:\/\//,
    description: 'Full base-URL override for the RM feed + artifacts (air-gapped mirrors). Wins over feed.owner/repo when set.',
  },
