// Context-menu definition. Called by @omegajs/desktop EVERY time the user right-clicks.
//
...
//
// This file is OPTIONAL — delete it and @omegajs/desktop still ships a working context menu.
//
// @omegajs/desktop ships a default template (built per-event from params) with these ids (flat):
...
module.exports = ({ manager, menu, params, webContents }) => {
  // Start from @omegajs/desktop's default template. Don't add anything by default — leave it
